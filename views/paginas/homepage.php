<main class="contenedor seccion">
        ...
        <div class="iconos-nosotros">
            <div class="icono">
                ...
                <h3>Seguridad</h3>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Suscipit perferendis animi cupiditate. Eius, tenetur. Possimus harum quae laboriosam asperiores corrupti voluptate libero ipsum modi eligendi beatae. Fugit minus corrupti molestias.</p>
            </div>
            <div class="icono">
    ...
    <div class="contenedor seccion seccion-inferior">
        <section class="blog">
            ...
            <article class="entrada-blog">
                <div class="imagen entrada-img">
                    <picture>
                        <source srcset="build/img/blog1.webp" type="image/webp">
                        <source srcser="build/img/blog1.jpg" type="image/jgp">
            ...
            <article class="entrada-blog">
                <div class="imagen entrada-img">
                    <picture>
                        ...
                        <source srcser="build/img/blog2.jpg" type="image/jgp">
